<header class="bg-[#121212] shadow-sm p-3 flex items-center justify-between">
    <h1 class="flex items-center font-bold tracking-wide">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center">
            <img
                ...
                alt="logo Prototype disini"
                class="w-8 h-8 rounded-full"
            />
            <span class="ml-2 text-sm font-medium text-white">Prototype dulu</span>
        </div>
    </div>
</header>