...
<div class="dashboard-container">
    ...
    <div class="stats-container">
        ...
        <a href="?page=taken" class="stat-card stat-orange clickable">
            <div class="stat-icon">
                <i class="fas fa-clock"></i>
            </div>
            <div class="stat-info">
    ...
    <div class="content-grid">
            ...
            <div class="activity-list">
                <?php if($recent_todos->num_rows > 0): ?>
                    ...
                    <div class="activity-item">
                        ...
                        <div class="task-status status-<?= $todo['task_status'] ?>">
        ...
        <div class="content-card">
            <div class="card-header">
                <h3><i class="fas fa-chart-bar"></i> Performa Aplikasi</h3>
                <a href="?page=apps" class="view-all">Kelola Apps</a>
            </div>
            <div class="app-performance">
                <?php if($app_performance->num_rows > 0): ?>
                    <?php while($app = $app_performance->fetch_assoc()): ?>
                    <div class="app-perf-item">
                        <div class="app-name"><?= htmlspecialchars($app['name']) ?></div>
                        <div class="app-stats-mini">
                            <div class="mini-stat completed">
                                <span class="value"><?= $app['completed'] ?></span>
                                <span class="label">Done</span>
                            </div>
                            <div class="mini-stat progress">
                                <span class="value"><?= $app['in_progress'] ?></span>
                                <span class="label">Progress</span>
                            </div>
                            <div class="mini-stat available">
                                <span class="value"><?= $app['available'] ?></span>
                                <span class="label">Available</span>
                            </div>
                        </div>
                        <div class="progress-bar-mini">
                            <div class="progress-fill" style="width: <?= $app['total_todos'] > 0 ? ($app['completed'] / $app['total_todos']) * 100 : 0 ?>%"></div>
                        </div>
                    </div>
                    <?php endwhile; ?>
                <?php else: ?>
        ...
        <div class="content-card">
            <div class="card-header">
                <h3><i class="fas fa-users"></i> Distribusi User</h3>
                <a href="?page=users" class="view-all">Kelola Users</a>
            </div>
                ...
                <?php if($user_stats->num_rows > 0): ?>
                    ...
                    <div class="role-item">
                        <div class="role-info">
                            ...
                            <span class="role-count"><?= $stat['count'] ?> users</span>
                        </div>
                        <div class="role-bar">
                            <div class="role-progress role-<?= $stat['role'] ?>" 
                                 style="width: <?= $stat['percentage'] ?>%"></div>
                        </div>
                        <div class="role-percentage"><?= $stat['percentage'] ?>%</div>
                    </div>
                    <?php endwhile; ?>
                <?php else: ?>
                    <div class="empty-state">
        ...
        <div class="content-card">
            ...
            <div class="quick-actions">
                ...
                <a href="?page=apps" class="quick-btn btn-green">
                    <i class="fas fa-cube"></i>
                    <span>Kelola Apps</span>
                </a>
                <a href="?page=users" class="quick-btn btn-orange">
                    <i class="fas fa-user-plus"></i>
                    <span>Tambah User</span>
                </a>
                <a href="?page=taken" class="quick-btn btn-purple">
                    <i class="fas fa-tasks"></i>
                    <span>Lihat Progress</span>
                </a>
            </div>
